...
-->
        ...
        <div class='chat__popular-list'>
            ...
            <div class='chat__room-list-wrapped' v-show='popularChatDisplay'>
                    ...
                    <div class='chat__room-list' v-for='popular in _popularChatList' :key='popular.chatRoomId+"popular"'>
                    <a-badge  :dot="true" style='margin-right:8px;'>
                        <div class="chat-room__logo"
                        :style='{"background-image":"url(" + "https://wejustgos3.s3.ap-northeast-2.amazonaws.com/logo/"+ onReplaceSpace(popular.chatRoomEng) +"logo.jpg" + ")"}' />
                    </a-badge>

                        <div class='chat__room-content'>
                            <div class='chat__room-title'>
                                <p class='no-margin txt-xs'>{{popular.chatRoomKor}}</p>
                            </div>
                            <p class='no-margin txt-2xs'>
                                {{popular.lastMsg}}
                            </p>
  ...
  export default {
    ...
    async onSelect(value) {
        ...
        this.CHAT_ENTER({
            ...
            chatRoomNameEng : temp.collegeEng,
        })
    },
