...
-->
        ...
        <div class='summary-block last'>
            ...
            <div class='summary-block-content'>
                <img class='summary-block-content__image' src='../../static/icon/etc/airplane.svg'>
                <span class='summary-block-cotent__txt'>
                    <p class='txt-xs no-margin'>{{_collegeDetailData.address.countryKor}}까지의 편도 요금은,</p>
                    <p class='txt-xl no-margin'>{{addComma(_skyscanner.MinPrice)}}원 입니다</p>
                </span>
            </div>
        </div>
