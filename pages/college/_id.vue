        ...
        <div class='college-information__content college__width'>
            ...
            <div class='college__navigation-list-wrapped'>
                <a-anchor>
                    ...
                    <a-anchor-link href="#blog-info" title="블로그 리뷰" />
                    <a-anchor-link href="#youtube-info" title="유튜브 리뷰"/>
                    <a-anchor-link v-if='_collegeDetailData.applyAvailable.applyCollegeSearchUrl.length'
                    href="#college-review" title="타 대학 리뷰" />
            ...
            <div class='college-information__content-block-wrapped'>
                ...
                <college-review v-if='_collegeDetailData.applyAvailable.applyCollegeSearchUrl.length' id='college-review' />
