<template>
  <div>
    ...
    <div class='header-container' :class="{'header-container__non_main' : ! _headerStyle}">
    <header>
      <a href="/">
...
.header-container__non_main {
  position: unset!important;
  background-color: #2A7FF6!important;
  background : none;
}
